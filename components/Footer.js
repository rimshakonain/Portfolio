...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-50 w-[95vw] sm:w-[90vw] md:w-[80vw] mx-auto text-gray-800 h-auto md:h-68 pt-8 pb-6 z-50 relative">
      <div className="container mx-auto flex flex-wrap justify-center md:justify-around gap-8 md:gap-0">
        ...
        <div className='flex flex-col min-w-[140px]'>
          ...
          <div className='flex flex-col space-y-2'>
            <Link className='flex items-center space-x-2 text-gray-600 hover:text-gray-900' href="https://github.com/rimshakonain" target='_blank'>
              <Image width={23} height={23} src="/github.svg" alt="GitHub" />
              <span>GitHub</span>
            </Link>

            <Link className='flex items-center space-x-2 text-gray-600 hover:text-gray-900' href="https://www.linkedin.com/in/rimsha-konain-c" target='_blank'>
              <Image width={20} height={20} src="/linkedin.svg" alt="LinkedIn" />
              <span>LinkedIn</span>
            </Link>

            <Link className='flex items-center space-x-2 text-gray-600 hover:text-gray-900' href="https://www.instagram.com/rimshacomix/?hl=en" target='_blank'>
              <Image width={20} height={20} src="/Instagram.svg" alt="Instagram" />
              <span>Instagram</span>
            </Link>

            <Link className='flex items-center space-x-2 text-gray-600 hover:text-gray-900' href="mailto:rimshakonainc@gmail.com" target='_blank'>
              <Image width={20} height={20} src="/Gmail.svg" alt="Email" />
              <span>Email</span>
            </Link>
          </div>
        </div>
